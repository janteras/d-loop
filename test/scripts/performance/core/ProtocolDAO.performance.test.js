...
describe("ProtocolDAO Performance Benchmarks", function() {
  ...
  before(async function() {
    ...
    protocolDAO = await ProtocolDAO.deploy(
      ...
      admin.address,      // _treasury (using admin for simplicity in tests)
      VOTING_PERIOD * 100, // _votingPeriod in seconds
      86400,              // _executionDelay (1 day in seconds)
      QUORUM              // _quorum percentage
    );
